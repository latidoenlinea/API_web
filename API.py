...
class SessionData:
    def __init__(self):  # ✅ CORREGIDO: __init__ en lugar de **init**
...
def process_video():
    ...
    try:
        ...
        if session_data.has_enough_data(fps, 15):
            ...
            data_buffer, timestamps = session_data.get_data()  # ✅ CORREGIDO: sintaxis correcta
...
if __name__ == '__main__':  # ✅ CORREGIDO: __name__ en lugar de **name**
    start_cleanup_timer()
